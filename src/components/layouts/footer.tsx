    ...
    <footer>
      ...
      <div className="bg-white py-12">
        <div className="container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-3 lg:grid-cols-5">
          ...
          <div>
          <h4 className="mb-6 text-xl font-bold">Admin</h4>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <Link
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 text-gray-600 transition-colors hover:border-primary hover:bg-black hover:text-white"
                aria-label="Facebook"
              >
      ...
      <div className="bg-black py-4 text-center text-white">
        <div className="container mx-auto px-4">
          <p>Copyright © All rights reserved. Website Developed & Managed by <Link href={'/salmanbd.com'}>MD. ABU SALMAN</Link></p>
        </div>
      </div>
    </footer>
  )
